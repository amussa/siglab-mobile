...
public class LMISBiosecurityMaterialRequisitionActivity extends BaseActivity {
    ...
    public static Intent getIntentToMe(Context context, long formId) {
        Intent intent = new Intent(context, LMISBiosecurityMaterialRequisitionActivity.class);
